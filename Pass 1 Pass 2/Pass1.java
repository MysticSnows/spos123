...
public class Pass1 {
	public static void main(String[] args) {
		...
		try {
			String inputfilename = "/mnt/Media_Study/Engineering/Pass 1 Pass 2/Input.txt";
			fr = new FileReader(inputfilename);
			br = new BufferedReader(fr);

			String OUTPUTFILENAME = "/mnt/Media_Study/Engineering/Pass 1 Pass 2/IC.txt";
			...
			String s1 = sCurrentLine.split(" ")[1];	// line separate by space, returns array and in s1, index at 1st element is returned
			if (s1.equals("START")) {
				bw.write("AD \t 01 \t");
			...
			while ((sCurrentLine = br.readLine()) != null) {
				...
				int flag2 = 0; // check if addr is assigned to current symbol

				String s = sCurrentLine.split(" |\\,")[0]; // consider first word in the line
				...
				int isOpcode = 0; // to check current word is an opcode or not

				s = sCurrentLine.split(" |\\,")[1]; // consider the second word in line
			...
			String f1 = "/mnt/Media_Study/Engineering/Pass 1 Pass 2/SYMTAB.txt";
			...
			String f2 = "/mnt/Media_Study/Engineering/Pass 1 Pass 2/LITTAB.txt";
			...
			String f3 = "/mnt/Media_Study/Engineering/Pass 1 Pass 2/POOLTAB.txt";
